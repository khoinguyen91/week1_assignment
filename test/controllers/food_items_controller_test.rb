...
class FoodItemsControllerTest < ActionController::TestCase
  ...
  test "should create food_item" do
    assert_difference('FoodItem.count') do
      post :create, food_item: { count_view: @food_item.count_view, cuisine: @food_item.cuisine, description: @food_item.description, img_url: @food_item.img_url, name: @food_item.name, price: @food_item.price, section: @food_item.section }
    end
  ...
  test "should update food_item" do
    patch :update, id: @food_item, food_item: { count_view: @food_item.count_view, cuisine: @food_item.cuisine, description: @food_item.description, img_url: @food_item.img_url, name: @food_item.name, price: @food_item.price, section: @food_item.section }
    assert_redirected_to food_item_path(assigns(:food_item))
  end
